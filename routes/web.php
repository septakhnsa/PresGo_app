...
Route::middleware(['auth'])->group(function () {
    // Rute yang butuh KRS sudah komplit (krs_completed == 1)
    Route::middleware([\App\Http\Middleware\CheckKrsCompleted::class])->group(function () {
    ...
    Route::get('/krs',         [MahasiswaWebController::class, 'krsPage'])->name('mahasiswa.krs');
    Route::post('/krs/submit', [MahasiswaWebController::class, 'submitKrs'])->name('mahasiswa.krs.submit');
    Route::get('/krs/poll',    [MahasiswaWebController::class, 'pollKrsStatus'])->name('mahasiswa.krs.poll');
});
